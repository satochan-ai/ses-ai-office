...
const agentIds = ["manager", "analytics", "newbiz", "bp", "matching", "recruit", "follow"];
...
export function useRouteMovement(stepId: number | undefined, demoStatus: DemoStatus, speed: DemoSpeed, instructionStates: AgentAnimationMap) {
  ...
  useEffect(() => {
    ...
    if (demoStatus === "paused" || (!stepId && !hasInstruction)) return;
  ...
  }, [demoStatus, instructionStates, plans, speed, stepId]);
